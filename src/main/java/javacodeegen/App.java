...
//            System.out.println(executeStatementResult);
//        } catch (Exception e) {
...
//                                          .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("http://127.0.0.1:8080", region))
//                                          .build();
//    }
//
//    private static ExecuteStatementRequest createExecuteStatementRequest() {
//        ExecuteStatementRequest request = new ExecuteStatementRequest();
//        request.setStatement("select * from test_table");
//        return request;
//    }
//
...
//                               .withStatement("select rewqa"));
//
//        statements.add(new BatchStatementRequest()
//                               .withStatement("fdsafds"));
//
//        return statements;
//    }
//
